...
enum STATS_TYPE {
    ...
    STATS_TYPE_VPN_ICMP_DNAT,
    STATS_TYPE_VPN_ICMP_DNAT_MISS,
    STATS_TYPE_VPN_L4_SNAT,
    STATS_TYPE_VPN_L4_DNAT,
    STATS_TYPE_VPN_FRAGMENT_PASS,
    STATS_TYPE_VPN_MTU_PASS,
    STATS_TYPE_VPN_PORT_ALLOC_MISS,
    STATS_TYPE_XDP_PASS,
    ...
    STATS_TYPE_VPN_DNAT_FIB_LOOKUP_ERROR,
    STATS_TYPE_NON_IPV4_PASS,
    STATS_TYPE_IPV4_FRAGMENT_PASS,
